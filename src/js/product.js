...
// // we have our product ID and we have the datascource 
// // we want the actual product details now, call the class that will
// // generate the details to be shown. 
...
// .addEventListener("click", product.init());
